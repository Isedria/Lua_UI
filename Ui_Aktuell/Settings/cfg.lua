...
cfg.modules = {
	...
	buffs = { 
		["enable"] = false,					-- enable buffFrame modifications
	...
	xp_bar = { 
		["enable"] = false,					-- enable experience bar
	...
	quest 				= {
		["enable"] = false,					-- enable quest log modifications (level, wowhead link etc.)
		["auto_collapse"] = true,			-- auto collapse watch frame when in instance
	},
	raid_buffs = {
		["enable"] = false,					-- enable raid buffs checking module
	...
	raid_cd = {-- its a new feature, im testing the function in the next days
	...
	move_score_frame = {					-- (new) reposition zone score frame and capture bars
		["enable"] = false,					
